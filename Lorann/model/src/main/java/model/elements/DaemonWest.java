 ...
 * @version 1.0
 */
public class DaemonWest extends Object implements IMobile {
     ...
     *            the current scene
     */
	public DaemonWest(final int x, final int y, final Scene scene) {
		super(Type.TYPE_DAEMON, x, y, false, new Sprite(Sprite.SPRITE_DAEMONW, 0, 1), scene);
